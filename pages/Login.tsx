...
const Login: React.FC = () => {
  ...
  const handleLogin = async (e: React.FormEvent) => {
    ...
    if (success) {
      // Find the user to redirect correctly (since state update might be async)
    ...
    <div className="min-h-screen flex items-center justify-center p-4 bg-background-light dark:bg-background-dark transition-colors duration-300">
      <main className="w-full max-w-5xl mx-auto flex flex-col items-center">
        ...
        <div className="mt-16 text-center">
          ...
          <p className="text-xs text-gray-300 dark:text-gray-600 mt-6">© 2026 Camila Gutiérrez Brokers Inmobiliarios. Todos los derechos reservados.</p>
